    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-location-outline"></i> 球桌消费列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
            ...
            >
                <el-table-column label="球桌消费编码" prop="table_bill" width="120">
                </el-table-column>
...
import { getSpendingtableAllInfo, deleteSpendingtable } from '../../../network/spendingtable';
...
export default {
    ...
    methods: {
        getDatapage() {
            ...
            getSpendingtableAllInfo(this.query).then(res => {
                if (res.code == 0) {
                    this.Data = res;
