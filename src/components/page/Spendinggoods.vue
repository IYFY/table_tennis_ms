    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-goods"></i> 商品消费列表
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column label="消费编码" prop="bill_code" width="120">
                </el-table-column>
                <el-table-column label="商品名称" prop="goods.goods_name">
                </el-table-column>

                <el-table-column label="购买数量" prop="goods_count" width="120">
                </el-table-column>
...
import { getSpendinggoodsAllInfo, deleteSpendinggoods } from '../../../network/spendinggoods';
...
export default {
    ...
    methods: {
        getDatapage() {
            ...
            getSpendinggoodsAllInfo(this.query).then(res => {
                if (res.code == 0) {
                    this.Data = res;
        ...
        handleDelete(row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(async () => {
                    const data = await deleteSpendinggoods(row);
